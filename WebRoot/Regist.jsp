    ...
    <div id="content"> 
      ...
      <div id="main">
        ...
        <div class="post">
          ...
          <form action="<%=SContext.BaseURL + com.entities.Constent.CONTROLLERSERVLET + com.entities.Constent.REGIST_CMD%>" method="post">
          <%
          if (SContext.RegistErrMsg != "") {
           %>
           <div style="color: red">
           <%=SContext.RegistErrMsg %>
           </div>
           <%
           }
            %>
