...
List<User> filteredUsers = SContext.filteredUsers;// (List<User>)request.getAttribute("filteredUsers");
 %>
    <!-- content START -->
    <div id="content"> 
	...
	%>
        <div class="post" style="width: 80%; margin-left: 20px;">
                ...
                <div class="searchItem">
                  <div class="l">  </div>
                  <div class="r"> 
                    <%if (!SContext.IsFriendWith(u)) { %>
                    <a href="<%= SContext.BaseURL + com.entities.Constent.ADDFRIENDREQUESTPAGE %>?id=<%= u.getUserId() %>" title="FindFriends">Add as friend</a>
                    <%} %>
                  </div>
                  <div class="fixed"></div>
                </div>
